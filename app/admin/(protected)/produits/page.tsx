...
// /admin — pas de portail unifié pour l'instant (cf. plan D-QUINCA §0). Cette page
// est juste un point d'entrée pratique listant les espaces admin disponibles ;
// se connecter sur un produit externe demande ses propres identifiants admin.
const produits = [
  {
    nom: 'SIGGIE',
...
export default function ProduitsAdminPage() {
  return (
    <div>
      <h1 className="text-2xl font-bold font-heading mb-2">Produits DembaSolution</h1>
