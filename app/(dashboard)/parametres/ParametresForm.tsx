...
export default function ParametresForm({ gie }: { gie: Gie }) {
    ...
    <div className="max-w-2xl space-y-8">
      ...
      <form action={handleSubmit} className="rounded-xl border border-surface-border bg-surface p-6 space-y-4">
        ...
        <div>
          ...
          <input name="identification" type="text" defaultValue={gie.identification} placeholder="Ex : NINEA 0012345678" className="mt-1 block w-full rounded-md bg-background border border-surface-border text-foreground px-3 py-2" />
        </div>
