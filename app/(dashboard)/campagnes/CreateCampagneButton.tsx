...
export default function CreateCampagneButton({ dict }: { dict: any }) {
              ...
              <div className="bg-surface px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                ...
                <form action={handleSubmit} id="add-campagne-form" className="space-y-4">
                  <div>
                    ...
                    <input type="text" name="nom" required placeholder={d.modal.name_placeholder} className="mt-1 block w-full rounded-md bg-background border border-surface-border text-foreground px-3 py-2" />
                  </div>
                  ...
                  <div>
                    ...
                    <input type="text" name="produit_collecte" placeholder={d.modal.product_placeholder} className="mt-1 block w-full rounded-md bg-background border border-surface-border text-foreground px-3 py-2" />
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
