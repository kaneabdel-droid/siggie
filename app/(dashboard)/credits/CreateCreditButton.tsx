...
export default function CreateCreditButton({ campagnes, dict }: { campagnes: Campagne[]; dict: any }) {
            ...
            <div className="relative transform overflow-hidden rounded-lg bg-surface text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg border border-surface-border">
              <div className="bg-surface px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                ...
                <form action={handleSubmit} id="add-credit-form" className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-foreground">{d.modal.linked_campaign}</label>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-foreground">{d.modal.bank_optional}</label>
                  ...
                  <div>
                    ...
                    <textarea name="but_credit" rows={3} placeholder={d.modal.reason_placeholder} className="mt-1 block w-full rounded-md bg-background border border-surface-border text-foreground px-3 py-2"></textarea>
                  </div>
                </form>
              </div>
